...
- [Built-in templates from integration providers as targets](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/gateway-target-integrations.html) in agentcore gateway
